...
function irPasso(destino) {
  if (destino > estado.stepAtual && !validarPasso(estado.stepAtual)) return
  ...
  if (estado.stepAtual === 2) {
    ...
    document.getElementById('summary-box').innerHTML =
      `Criando conta para o <strong>Apto ${estado.aptoSelecionado}</strong> · ${nome}`
  }
}
